...
export const metadata: Metadata = {
  title: "О компании",
  description:
    "VED — сервис импорта авто под заказ: подбор, расчёты, оформление и логистика в Россию.",
  alternates: {
    canonical: "/about",
  },
  openGraph: {
    ...
    <main className="relative ved-screen bg-ved-navy">
      ...
      <div className="relative z-10 mx-auto max-w-3xl px-8 py-12 md:px-12">
        ...
        <p className="mt-8 text-lg font-light leading-relaxed text-white/85">
          VED — сервис импорта авто под заказ. Мы помогаем купить машину из Китая и других азиатских
          рынков в Россию прозрачно по стоимости и без лишних сложностей.
        </p>

        <p className="mt-5 leading-relaxed text-white/65">
          Наша задача — сделать покупку авто за рубежом понятной: от Вашего первого запроса до
          вручения ключей. Вы выбираете автомобиль и бюджет. Это может быть как новая машина, так и
          авто с пробегом, а мы берём на себя автоподбор, расчёты, оформление и логистику.
        </p>

        <p className="mt-5 leading-relaxed text-white/65">
          На сайте vedcompany.ru можно купить автомобиль из каталога, сравнить аналоги по типу
          кузова и бюджету, оставить заявку менеджеру и отслеживать заказ в личном кабинете.
        </p>
