...
export function CarCardMini({ car }: { car: Car }) {
  ...
  return (
    <Link
      href={`/catalog/${car.id}`}
      className="group flex min-w-[240px] shrink-0 gap-3 border border-white/10 bg-white/5 p-3 transition hover:border-white/25 hover:bg-white/10 sm:min-w-0"
    >
      <div
